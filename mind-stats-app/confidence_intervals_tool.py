...
# ==========================================================
# Confidence Interval for the Mean (σ unknown, given s or data)
# ==========================================================
...
# ==========================================================
# Continuous Probability Tools Placeholder (Normal / Uniform etc.)
# ==========================================================
def placeholder_message():
    st.info("📘 Continuous distributions (Normal, Sampling, Uniform) can be found in the 'Continuous Distributions' tool.")
...
def run():
    ...
    if tool == "Uniform Distribution":
        placeholder_message()
    elif tool == "Normal Distribution":
        placeholder_message()
    elif tool == "Sampling Distribution of the Mean":
        placeholder_message()
    elif tool == "Sampling Distribution of the Proportion":
        placeholder_message()
    elif tool.startswith("Confidence Interval for Mean"):
