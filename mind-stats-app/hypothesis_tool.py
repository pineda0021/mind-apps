...
def run_hypothesis_tool():
    ...
    alpha = st.number_input("Significance level (e.g., 0.05)", value=0.05, min_value=0.0001, max_value=0.5)
    tails = st.selectbox("Tails", ["two", "left", "right"])
    decimal_places = st.number_input("Decimal places for rounding", min_value=1, max_value=10, value=4)
